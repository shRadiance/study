...
<body>
	<div class="container">
		<form class="form-signin" action="/register/form" method="post">
			<h1 class="h3 mb-3 font-weight-normal">注册</h1>
			<label for="inputEmail" class="sr-only">请输入姓名</label>
			<input type="text" id="inputName" name="name" class="form-control" placeholder="请输入姓名" required>
			...
			<label for="inputPassword" class="sr-only">电话号码</label>
			<input type="text" id="inputPhone" name="phoneNumber" class="form-control" placeholder="请输入电话号码">
